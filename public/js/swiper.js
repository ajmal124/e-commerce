...
!(function () {
            ...
            const a = (e, s, i) => {
                let a = t.isHorizontal()
                    ...
                    r = t.isHorizontal()
                        ? e.querySelector(".swiper-slide-shadow-right")
                        : e.querySelector(".swiper-slide-shadow-bottom");
                a || (a = pe(0, e, t.isHorizontal() ? "left" : "top")),
                ...
                setTranslate: () => {
                    ...
                    for (let s = 0; s < e.length; s += 1) {
                        ...
                        const c = i.swiperSlideOffset,
                            u = [
                                t.params.cssMode ? -c - t.translate : -c,
                                0,
                                0,
                            ],
                            m = [0, 0, 0];
    ...
    function he(e, t) {
        ...
        Object.keys(t)
            ...
            .forEach((s) => {
                void 0 === e[s]
                    ? (e[s] = t[s])
                    : me(t[s]) && me(e[s]) && Object.keys(t[s]).length > 0
                    ? t[s].__swiper__
                        ? (e[s] = t[s])
                        : he(e[s], t[s])
                    : (e[s] = t[s]);
    ...
    function we(e) {
        ...
        return (
            ...
            [...e.attributes].forEach((e) => {
                const t = ve.filter((t) => 0 === e.name.indexOf(`${t}-`))[0];
                if (t) {
                    const i = fe(t),
                        a = fe(e.name.split(`${t}-`)[1]);
                    s[i] || (s[i] = {}),
                        !0 === s[i] && (s[i] = { enabled: !0 }),
                        (s[i][a] = ge(e.value));
                } else {
                    ...
                    const i = ge(e.value);
                    s[t] && ve.includes(e.name)
                        ? (s[t].constructor !== Object && (s[t] = {}),
                          (s[t].enabled = i))
                        : (s[t] = i);
                }
            }),
    ...
    const Ee = (e, t) => {
        ...
        !e &&
            ...
            (s && !i) ||
                ...
                (s.textContent = [ye, t ? t.cssStyles() : ""].join("\n")),
    ...
    class Ae extends Se {
        ...
        initialize() {
            ...
            this.initialized = !0;
            const { params: t, passedParams: s } = we(this);
            (this.swiperParams = t),
                (this.passedParams = s),
                delete this.swiperParams.init,
                this.render(),
                (this.swiper = new J(this, {
                    ...t,
    ...
    "undefined" != typeof window &&
        ...
        "undefined" != typeof window &&
            ...
            window.customElements.get("swiper-container") ||
                window.customElements.define("swiper-container", Ae),
            window.customElements.get("swiper-slide") ||
                window.customElements.define("swiper-slide", Te));
})();
